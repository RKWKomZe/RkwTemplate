...
(19, '#@pid_law#', '#@tstamp#', 2560, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Impressum', 1, 0, 0, 0, 0, '', 0, 0, 0, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 6, 10, 0, 0, NULL),
(20, '#@pid_law#', '#@tstamp#', 3072, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Datenschutz', 1, 0, 0, 0, 0, '', 0, 0, 0, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 6, 10, 0, 0, NULL),
(21, '#@pid_law#', '#@tstamp#', 2944, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Allgemeine Geschäftsbedingungen', 1, 0, 0, 0, 0, '', 0, 0, 0, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 6, 10, 0, 0, NULL),
(22, '#@pid_law#', '#@tstamp#', 2816, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Allgemeine Nutzungsbedingungen', 7, 0, 0, 0, 0, '', 0, 1381, 1, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 0, 0, 0, 0, NULL),
(23, '#@pid_law#', '#@tstamp#', 3328, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Disclaimer', 1, 0, 0, 0, 0, '', 0, 0, 0, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 6, 10, 0, 0, NULL),
(24, '#@pid_law#', '#@tstamp#', 3008, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Bildnachweise', 1, 0, 0, 0, 0, '', 0, 0, 0, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 6, 10, 0, 0, NULL),
...
(26, '#@pid_other#', '#@tstamp#', 256, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Weiterleitung', 1, 0, 0, 0, 0, '', 1, 0, 0, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 6, 8, 0, 0, NULL),
(27, '#@pid_dataset#', '#@tstamp#', 640, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', '#@website_title#', 254, 0, 0, 0, 0, '', 0, 0, 0, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 0, 0, 0, 0, NULL),
(28, '#@pid_dataset_folder#', '#@tstamp#', 256, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Autoren', 254, 0, 0, 0, 0, '', 0, 0, 0, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 0, 0, 0, 0, NULL),
(29, '#@pid_dataset_folder#', '#@tstamp#', 512, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Projekte', 254, 0, 0, 0, 0, '', 0, 0, 0, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 0, 0, 0, 0, NULL),
(30, '#@pid_dataset_folder#', '#@tstamp#', 768, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Veranstaltungen', 254, 0, 0, 0, 0, '', 0, 0, 0, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 0, 0, 0, 0, NULL);
