...
(8, '#@pid_website#', '#@tstamp#', 1536, 1, '#@perms_userid#', '#@perms_groupid#', '#@perms_user#', '#@perms_group#', '#@perms_everybody#', '#@tstamp#', 'Mein RKW', 1, 0, 609, 0, 0, 'Mit uns finden Sie immer die passende Lösung', 0, 0, 1, '#@layout_backend_current#', '#@layout_backend_children#', '#@layout_frontend_current#', '#@layout_frontend_children#', 6, 0, 0, 2, NULL),
