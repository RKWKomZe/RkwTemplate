...
plugin.tx_rkwtemplate_config {
    paths {
        default {
            ...
            images = EXT:rkw_template/Resources/Public/Kompetenzzentrum/_Microsites/WebsiteCheck/images

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to logos
            logos = EXT:rkw_template/Resources/Public/Kompetenzzentrum/_Microsites/WebsiteCheck/images/logos
        }
    }
