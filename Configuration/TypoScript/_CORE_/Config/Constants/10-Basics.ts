...
plugin.tx_rkwtemplate_config {
    ...
    paths {
        ...
        default {
            ...
            templates = EXT:rkw_template/Resources/Private/Templates/_CORE_

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to partials
            partials = EXT:rkw_template/Resources/Private/Partials/_CORE_

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to layouts
            layouts = EXT:rkw_template/Resources/Private/Layouts/_CORE_

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to CSS-file
            css = EXT:rkw_template/Resources/Public/_CORE_/Css

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to images
            images = EXT:rkw_template/Resources/Public/_CORE_/Images

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to logos
            logos = EXT:rkw_template/Resources/Public/_CORE_/Images/Logos

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to icons
            icons = EXT:rkw_template/Resources/Public/_CORE_/Images/Icons

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to JavaScripts
            js = EXT:rkw_template/Resources/Public/_CORE_/JavaScripts

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to special stuff
            specials = EXT:rkw_template/Resources/Public/_CORE_/Specials

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to libs
            lib = EXT:rkw_template/Resources/Public/_CORE_/Lib
        }

        extensions {
            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to templates
            templates = EXT:rkw_template/Resources/Private/Templates/_CORE_/Extensions

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to partials
            partials = EXT:rkw_template/Resources/Private/Partials/_CORE_/Extensions

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to layouts
            layouts = EXT:rkw_template/Resources/Private/Layouts/_CORE_/Extensions
        }

        microsite {

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to images
            mainWebsiteImages = EXT:rkw_template/Resources/Public/_CORE_/Images

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to logos
            mainWebsiteLogos = EXT:rkw_template/Resources/Public/_CORE_/Images/Logos
        }
    }
