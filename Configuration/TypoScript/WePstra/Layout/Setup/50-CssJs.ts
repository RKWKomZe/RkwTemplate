...
page {
	...
	headerData {
		...
		20 {
			...
			value = <script src="{$globalWebsiteConfig.templatePaths.default.js}/libs/html5shiv.js</script>
    ...
    includeCSS {
        ...
        // Landingpage only!
        file20 = {$globalWebsiteConfig.templatePaths.default.css}/main.css
    ...
    includeJSFooterlibs {
        ...
        // Landingpage only!
        file20 = {$globalWebsiteConfig.templatePaths.default.js}/main.js
        file20.if {
            value = 5
            equals.data = levelfield:-2,tx_rkwbasics_fe_layout_next_level,slide
            equals.override.field = layout
