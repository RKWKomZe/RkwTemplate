...
plugin.tx_rkwtemplate_config {
    paths {
        default {
            ...
            logos = EXT:rkw_template/Resources/Public/Kompetenzzentrum/_Websites/RkwBremen/images/logos
        ...
        extensions {
            ...
            partials = EXT:rkw_template/Resources/Private/Partials/Kompetenzzentrum/_Websites/RkwBremen/Extensions
        }
    }
