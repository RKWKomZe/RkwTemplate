...
plugin.tx_rkwtemplate_config {
    paths {
        ...
        default {
            ...
            logos = EXT:rkw_template/Resources/Public/Kompetenzzentrum/_Websites/RkwBadenWuerttemberg/images/logos
        ...
        extensions {
            ...
            partials = EXT:rkw_template/Resources/Private/Partials/Kompetenzzentrum/_Websites/RkwBadenWuerttemberg/Extensions
        }
    }

    # cat=plugin.tx_rkwtemplate_config; type=string; label=baseUrl (With / at the end for ClickEnlarge)
    baseUrl = https://bawue.rkw-kompetenzzentrum.de/
