...
plugin.tx_rkwtemplate_config {
    paths {
        default {
            ...
            logos = EXT:rkw_template/Resources/Public/Kompetenzzentrum/_Websites/RkwBundesverein/images/logos
        ...
        extensions {
            ...
            # partials = EXT:rkw_template/Resources/Private/Partials/Kompetenzzentrum/_Websites/RkwBundesverein/Extensions
        }
    }
