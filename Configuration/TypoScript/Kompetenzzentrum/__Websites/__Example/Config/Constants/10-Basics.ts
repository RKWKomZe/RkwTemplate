...
plugin.tx_rkwtemplate_config {
    paths {
        ...
        default {
            ...
            # logos = EXT:rkw_template/Resources/Public/Kompetenzzentrum/__Websites/__Example/images/logos

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to icons
            # icons = EXT:rkw_template/Resources/Public/Kompetenzzentrum/__Websites/__Example/images/icons/grey
        }

        extensions {

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to partials
            partials = EXT:rkw_template/Resources/Private/Partials/Kompetenzzentrum/__Websites/__Example/Extensions
        }
    }
