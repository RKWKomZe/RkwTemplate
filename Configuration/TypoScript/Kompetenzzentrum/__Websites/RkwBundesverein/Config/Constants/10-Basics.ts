...
plugin.tx_rkwtemplate_config {
    paths {
        default {
            ...
            logos = EXT:rkw_template/Resources/Public/Kompetenzzentrum/__Websites/RkwBundesverein/images/logos

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to icons
            # icons = EXT:rkw_template/Resources/Public/Kompetenzzentrum/__Websites/RkwBundesverein/images/icons/grey
        }

        extensions {

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to partials
            # partials = EXT:rkw_template/Resources/Private/Partials/Kompetenzzentrum/__Websites/RkwBundesverein/Extensions
        }
    }

    # cat=plugin.tx_rkwtemplate_config; type=string; label=baseUrl (With / at the end for ClickEnlarge)
    baseUrl = https://www.rkw.de/
