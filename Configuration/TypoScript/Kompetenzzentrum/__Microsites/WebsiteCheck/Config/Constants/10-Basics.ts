...
plugin.tx_rkwtemplate_config {
    paths {
        default {
            ...
            images = EXT:rkw_template/Resources/Public/Kompetenzzentrum/__Microsites/WebsiteCheck/images

            # cat=plugin.tx_rkwtemplate_config/file; type=string; label=Path to logos
            logos = EXT:rkw_template/Resources/Public/Kompetenzzentrum/__Microsites/WebsiteCheck/images/logos
        }
    }

    # cat=plugin.tx_rkwtemplate_config; type=string; label=baseUrl (With / at the end for ClickEnlarge)
    baseUrl = https://www.karriereseiten-check.de/

    website {

        # cat=plugin.tx_rkwtemplate_config; type=string; label=Name of website
        name = RKW Karriereseiten-Check
